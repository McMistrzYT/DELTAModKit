...
if (global.menuno == 5)
{
    ...
    if (global.submenu == 35)
    {
        ...
        /*if (global.is_console)
        {
            ...
            draw_text(buttonXPos, buttonYPos, "Button");
        }
        else*/
        {
        ...
        my_function[2] = "UP";
        my_function[3] = "LEFT";
        my_function[4] = "CONFIRM";
        my_function[5] = "CANCEL";
        my_function[6] = "MENU";
        my_function[7] = "Reset to default";
        my_function[8] = "Finish";
...
if (global.menuno == 4)
{
    ...
    draw_sprite_ext(spr_dmenu_captions, 0, xx + 124, yy + 84, 2, 2, 0, c_white, 1);
    draw_sprite_ext(spr_dmenu_captions, 4, xx + 124, yy + 210, 2, 2, 0, c_white, 1);
    draw_sprite_ext(spr_dmenu_captions, 5, xx + 380, yy + 210, 2, 2, 0, c_white, 1);
	...
	scr_character_get_rank(charcoord);
	scr_character_get_powers(charcoord);
	
	for (pid = 0; pid < array_length(_powers); pid++) {
		var thing = _powers[pid];
		...
		// [ color, text, customDrawFunc(ch_y), icon, value ]
...
if (global.menuno == 2)
{
    ...
    if (global.submenu == 12 || global.submenu == 13 || global.submenu == 14)
    {
        ...
        if (global.submenu == 12)
			g = weaponchar[cur][charcoord] == false;
        
        if (global.submenu == 13 || global.submenu == 14)
			g = armorchar[cur][charcoord] == false;
